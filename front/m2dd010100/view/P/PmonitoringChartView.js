...
@mesAutobind
@observer
class PmonitoringChartView extends Component {
          ...
          <table className="ui table center">
            ...
            <tbody>
              <tr>
                ...
                <td className="right">{iron !== undefined ? iron.result[0].formAttrStdDtNmV22 : null}</td>
                <td className="right">{iron !== undefined ? iron.result[0].formAttrStdDtNmV23 : null}</td>
              </tr>
              <tr>
                <th>계획비</th>
                ...
                <td className="right">{iron !== undefined ? iron.result[1].formAttrStdDtNmV22 : null}</td>
                <td className="right">{iron !== undefined ? iron.result[1].formAttrStdDtNmV23 : null}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
export default PmonitoringChartView;
