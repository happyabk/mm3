...
@mesAutobind
@observer
class PmonitoringChart3View extends Component {
  //
  render() {
    ...
    if (cast !== undefined) {
      for (let i = 0; i < 3; i++) {
        if (cast[i].formAttrStdDtNmV14 !== undefined) {
          if (cast[i].formAttrStdDtNmV14 > sum1) {
            sum1 = cast[i].formAttrStdDtNmV14;
          }
        }
        if (cast[i].formAttrStdDtNmV12 !== undefined) {
          if (cast[i].formAttrStdDtNmV12 > sum1) {
            sum1 = cast[i].formAttrStdDtNmV12;
          }
        }
        if (cast[i].formAttrStdDtNmV13 !== undefined) {
          if (cast[i].formAttrStdDtNmV13 > sum1) {
            sum1 = cast[i].formAttrStdDtNmV13;
          }
        }
        if (cast[i].formAttrStdDtNmV35 !== undefined) {
          if (cast[i].formAttrStdDtNmV35 > sum1) {
            sum1 = cast[i].formAttrStdDtNmV35;
          }
        }
      }
    }
              ...
              <tbody>
                <tr>
                  ...
                  <td className="onchart">
                    <OneChart
                      bgcolor="#68c182"
                      chartwidth={`${cast !== undefined && cast[0].formAttrStdDtNmV35 !== 0 ? cast[0].formAttrStdDtNmV35 / cast1Sum * 100 : 0}%`}
                      text={cast !== undefined ? cast[0].formAttrStdDtNmV35 : null}
                      color="#333"
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="onchart">
                    <OneChart
                      bgcolor="#af98cf"
                      chartwidth={`${cast !== undefined && cast[1].formAttrStdDtNmV35 !== 0 ? cast[1].formAttrStdDtNmV35 / cast1Sum * 100 : 0}%`}
                      text={cast !== undefined ? cast[1].formAttrStdDtNmV35 : null}
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="onchart">
                    <OneChart
                      bgcolor="#5a8677"
                      chartwidth={`${cast !== undefined && cast[2].formAttrStdDtNmV35 !== 0 ? cast[2].formAttrStdDtNmV35 / cast1Sum * 100 : 0}%`}
                      text={cast !== undefined ? cast[2].formAttrStdDtNmV35 : null}
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="right">{cast !== undefined ? cast[3].formAttrStdDtNmV35 : null}</td>
                </tr>
                <tr>
                  <td>평균주조시간</td>
                  ...
                  <td className="right">{cast !== undefined ? cast[4].formAttrStdDtNmV35 : null}</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export default PmonitoringChart3View;
